    ...
    <div className="min-h-screen bg-[#f4f4f7] print:bg-white print:p-0 print:m-0 text-zinc-900 pb-28 pt-2.5 sm:pt-4 px-2 sm:px-6 selection:bg-blue-600 selection:text-white">
      ...
      <header className="max-w-[960px] mx-auto mb-2.5 sm:mb-3 flex items-center justify-between text-xs text-zinc-600 no-print px-1 sm:px-2 gap-2">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 flex-shrink-0">
          ...
          <div className="flex items-center p-0.5 bg-zinc-200/90 rounded-lg text-[10.5px] sm:text-[11px] font-semibold border border-zinc-300/60 shadow-inner">
            <button
              onClick={() => setLang('en')}
              className={`px-2 sm:px-2.5 py-0.5 rounded-md transition-all ${lang === 'en'
            ...
            <button
              onClick={() => setLang('vi')}
              className={`px-2 sm:px-2.5 py-0.5 rounded-md transition-all ${lang === 'vi'
